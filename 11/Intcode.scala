...
class Intcode(program: List[Long], var in: ArrayBuffer[Long], var out: ArrayBuffer[Long], memory: Int = 1024) {
  val mem: Array[Long] = program.toArray ++ Array.fill(memory - program.size)(0.toLong)
  var at: Int = 0
  var rel: Int = 0
